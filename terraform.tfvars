...
parameters = {
  ...
  "docdb.dev.endpoint" = {
    type = "String", value = "dev-docdb-cluster.cluster-cxkya0oyqqlm.us-east-1.docdb.amazonaws.com"
  }
  "rds.dev.master_username" = { type = "String", value = "devadmin" }
  "rds.dev.database_name"   = { type = "String", value = "dummy" }

  "user.dev.REDIS_HOST" = {
    type = "String", value = "dev-redis-elasticache-cluster.y6smga.0001.use1.cache.amazonaws.com"
  }
  ...
  "shipping.dev.DB_HOST" = {
    type = "String", value = "dev-aurora-mysql-rds-cluster.cluster-cxkya0oyqqlm.us-east-1.rds.amazonaws.com"
  }
...
#------------------------------------------------------------------------------------------------------------------
  ...
  # Catalogue Pod
  "catalogue.dev.MONGO_URL" = { type = "SecureString", value = "mongodb://docdbadmin:roboshop1234@dev-docdb-cluster.cluster-cxkya0oyqqlm.us-east-1.docdb.amazonaws.com:27017/catalogue?tls=true&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false" }
  "catalogue.dev.DOCUMENTDB" = { type = "String", value = "true" }

  # User Pod
  "user.dev.MONGO_URL" = { type = "SecureString", value = "mongodb://docdbadmin:roboshop1234@dev-docdb-cluster.cluster-cxkya0oyqqlm.us-east-1.docdb.amazonaws.com:27017/users?tls=true&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false" }
